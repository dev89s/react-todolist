...
<div align="center">
  <!-- You are encouraged to replace this logo with your own! Otherwise you can also remove it. -->
    <br>
  <h1 style="font-size: 35px; color: lightblue"><b>TodoList React</b></h1>
...
# 📖 Todolist React <a id="about-project"></a>

**Todolist React** is a Single Page App (SPA) todolist. It is implemented using React. It uses cookies to save the todolist in the local machine. You can Add, Edit, check, and delete todos. There is also a navigation to other parts of the app that are not implemented yet. (Further updates will be implementing them)
...
- **Provide a todolist app in the browser**
- **It remembers the last state of todo items after refresh**
...
- An implementation of this portfolio is live on [Github Pages](https://dev89s.github.io/reac-todolist/build/) (to be updated)
...
### Setup
  ...
  2. Use "git" to clone this repository into your local drive:
      >```$ git clone https://github.com/dev89s/react-todolist.git```
...
- **About, Profile, Login implementation**: These pages will be implemented in future update.
